...
<Library LVVersion="20008000">
	...
	<Item Name="Engine" Type="Folder">
		<Item Name="Init" Type="Folder">
			<Item Name="Get DAQ Physical Channels.vi" Type="VI" URL="../Get DAQ Physical Channels.vi"/>
			<Item Name="Get DAQ Settings.vi" Type="VI" URL="../Get DAQ Settings.vi"/>
			<Item Name="Initialize DAQ.vi" Type="VI" URL="../Initialize DAQ.vi"/>
		</Item>
		<Item Name="Run" Type="Folder">
			<Item Name="Check Amplitude Offset Bounds.vi" Type="VI" URL="../Check Amplitude Offset Bounds.vi"/>
			<Item Name="Generate DAQ Waveform.vi" Type="VI" URL="../Generate DAQ Waveform.vi"/>
	...
	<Item Name="Inline HW RT Driver VI.vi" Type="VI" URL="../Inline HW RT Driver VI.vi"/>
